...
- Segmentation 1: Regular(users who have completed regularly irrespective of holidays), Sleeping, Holiday User(holiday based customers),  Inactive (canceled)  

- Variable Completed, pages, onsite, holiday
...
customer.segOne.rf.table

# calculate the accuracy of our random forest model
customer.segOne.rf.misclassificationrate = mean(customer.segOne.rf.predict != test.segOne$userType)
customer.rf.segOneaccuracy <- 1- customer.segOne.rf.misclassificationrate
customer.rf.segOneaccuracy
```
...
customer.knn.segOne
customer.knn.segOne.predict <- predict(customer.knn.segOne, test.segOne)
customer.knn.segOne.table <- table(customer.knn.segOne.predict, test.segOne$userType)
customer.knn.segOne.table

# calculate the accuracy of our random forest model
customer.knn.segOne.misclassificationrate = mean(customer.knn.segOne.predict != test.segOne$userType)
customer.knn.segOne.accuracy <- 1- customer.knn.segOne.misclassificationrate
customer.knn.segOne.accuracy
```
```
